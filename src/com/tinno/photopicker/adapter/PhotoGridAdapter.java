package com.tinno.photopicker.adapter;
...
import com.tinno.photopicker.R;
import com.tinno.photopicker.entity.Photo;
import com.tinno.photopicker.entity.PhotoDirectory;
import com.tinno.photopicker.event.OnItemCheckListener;
import com.tinno.photopicker.event.OnPhotoClickListener;
...
public class PhotoGridAdapter extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
  ...
  @Override public void onBindViewHolder(final PhotoViewHolder holder, final int position) {
    ...
    if (getItemViewType(position) == ITEM_TYPE_PHOTO) {
      ...
      holder.ivPhotoCover.setAlpha(isChecked ? 0.3f : 0f);
  ...
  public static class PhotoViewHolder extends RecyclerView.ViewHolder {
    ...
    private View ivPhotoCover;
    private View vSelected;

    public PhotoViewHolder(View itemView) {
      super(itemView);
      ivPhoto   = (ImageView) itemView.findViewById(R.id.iv_photo);
      ivPhotoCover = itemView.findViewById(R.id.iv_photo_select);
